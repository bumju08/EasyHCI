...
<br></br>**TM5는 단시간에 잘못된 램타이밍을 바로잡기 좋은 툴이며, HCI는 장기간에 걸쳐 온도와 전압 문제를 바로잡기 좋은 툴입니다. HCI를 사용하기 전에 TM5부터 사용하실 것을 권장합니다. 또한 테스트 툴은 모두 예방 차원에서 돌리는 것이므로 너무 지나치게 큰 신뢰를 가지시면 안됩니다.**<br></br> <br></br>
